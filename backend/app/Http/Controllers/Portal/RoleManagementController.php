...
class RoleManagementController extends Controller
{
    ...
    public function revokeAdmin(Request $request,User $user){abort_unless($request->user()->isSuperAdmin(),403);abort_if($user->isSuperAdmin(),403);if($user->isAdmin())$user->update(['role'=>'cadet']);return back()->with('success','Admin role revoked.');}
}
