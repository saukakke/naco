...
Route::middleware('auth:sanctum')->group(function (): void {
    ...
    Route::get('/me', fn (Request $request) => response()->json(
        $request->user()->load(['cadet','unit','ward','lga','state'])
    ));
    ...
    Route::get('/cadets/{cadet}/instructor', [InstructorController::class,'show']);
    Route::post('/cadets/{cadet}/instructor/courses/{course}/enroll',[InstructorController::class,'enroll']);
    Route::post('/cadets/{cadet}/instructor/courses/{course}/payment',[InstructorController::class,'payment']);
    Route::post('/cadets/{cadet}/instructor/courses/{course}/result',[InstructorController::class,'result']);
    Route::post('/cadets/{cadet}/instructor/courses/{course}/warrant',[InstructorController::class,'issueWarrant']);
